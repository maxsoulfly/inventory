<?  //header('Content-type: text/html; charset=windows-1251');
	...
	$page = "edit_return";
	if (isset($_POST['from_location'])) {$from_location = $_POST['from_location'];}
    else if(isset($_GET['from_location'])) {$from_location = $_GET['from_location'];}
    else if(isset($_GET['location_id'])) {$from_location = $_GET['location_id'];}
    else if(isset($_POST['location_id'])) {$from_location = $_POST['location_id'];}
	if (!isset($from_location)) {unset($from_location);}
                ...
                <div class="toggle-content" style="display: none;">
                    <? echo ("<div id='tab-".$categories['id']."' class='tab-content clear';>");?>
                      <div class="form-input clear push10">
                        ...
                        <h2 class="one_sixth font-medium"><strong>Вернуть: </strong></h2>
                    </div><br>
                </div>
				...
				<?
                    ...
                    if ($prodResult) {
                        ...
                        do{
                            ...
                            $returnAmount = get_product_transaction_amount($products['id'], $transaction_id);
                            //echo show_error("amount: ".$amount." | supply ".$supplyAmount ,"info",1);
                            if ($returnAmount == 0) $returnAmount="";
                            ?>
                            <div class="form-input clear push10">
                                ...
                                <p class="one_sixth">
                                    ...
                                    <input type="text" name="amount[]" value="<?=$returnAmount?>" size="22" class="fl-left" title="">
                                </p>
                            </div>
