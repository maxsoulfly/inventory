...
?>
            ...
            <p class="font-large">Вы собираетесь стереть информацию о операциях продукта "<strong><? echo $data['name']; ?></strong>", Вы Уверены?</p>
            <?
				echo show_error ("<p class='font-medium'>Вся информация о операциях будет потеряна.</p>","warning", 0);
			?>
        <form action="drop_transactions.php" method="post" name="delete_transactions">
