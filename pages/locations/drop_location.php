<? 
	...
	if (isset($_POST['id'])) { $location_id = $_POST['id']; if($location_id=="") {unset($location_id);}}
...
<?
			...
			if (isset($location_id)) {
				/* all ok -> sqlquery */
				$error = delete_location($location_id);

                $error .= delete_location_user($location_id);
				$footer_links = "<p class='clear'>
										<a class='fl_left' href='locations.php'>&laquo; Назад</a>
