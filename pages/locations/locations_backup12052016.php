...
<div class="clear push50">
    ...
    <table class="list-table  font-medium">
        ...
        <tr>
            ...
            <th>Продукт</span></th>
            <th>Цена<br>(a)</th>
            <th nowrap style="min-width: 150px">Операции <a href='../transactions/new_supply.php?to_location=<? echo $location_id; ?>'><span class='icon-plus'></span></a></th>
            <th nowrap>К-во<br>Шт. / кг.<br>(x)</th>
            <th nowrap>Получено <br>на &sum;<br>(a*x)</th>
            <th nowrap style="min-width: 150px">Возвраты (z) <a href='../transactions/new_return.php?id=<? echo $location_id; ?>'><span class='icon-plus'></span></a><br></th>
        ...
        <!--########################################[            product        ]#######################################################################################################-->
                    <td nowrap class='product'>
                        <span class="default full_width "><a href='#' name='changeName'><? echo $products['name']; ?></a></span>
                        <span class="">
                        </span>
